...
class Nivel:
    def __init__(self, pantalla, personaje_principal, mapa, imagen_fondo) -> None:
...
class Nivel_Uno(Nivel):
    def __init__(self, pantalla: pygame.surface.Surface):
        ...
        personaje_principal = Personaje(self.pantalla, self.animaciones_personaje, 50, ALTO-50, TAM_PERSONAJE, self.lista_bloques,self.sprites_enemigos, self.sprites_recompensas,self.sonidos, self.sprites_meta)
    ...
    def pantalla_perdio(self):
        ...
        if self.boton_reinicio.dibujar():
            ...
            self.personaje.reiniciar(self.pantalla, animaciones_personaje, 50, ALTO-50, TAM_PERSONAJE, self.lista_bloques,self.sprites_enemigos, self.sprites_recompensas,self.sonidos, self.sprites_meta)
...
class Nivel_Dos(Nivel):
        ...
        for fila in mundo:
            ...
            for bloque in fila:
                ...
                if bloque == 3:
                    ...
                    self.lista_bloques.append(bloque)
                if bloque == 5:
                    # trampa = Trampa(280, ALTO - 120, self.sierra_animaciones, TAM_TRAMPA, self.pantalla)
    ...
    def verificar_game_over(self):
        ...
        if self.game_over == 0:
            ...
            self.pantalla.blit(self.sprite_sierra, (0,0))
            pass
        # elif self.game_over == -1:
        #         self.pantalla_perdio()
        # elif self.game_over == 1:
